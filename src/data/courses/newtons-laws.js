...
These three laws together explain everything from falling apples to orbiting satellites. They were the foundation of all physics for over 200 years — and for most of the physical world you experience every day, they still are.`,

        // ── Blitz Statements ─────────────────────────────────
        blitz: [
            { id: 1, statement: "An object moving at constant velocity has no net force acting on it.", answer: true },
            { id: 2, statement: "A heavier object always falls faster than a lighter one.", answer: false },
            { id: 3, statement: "Newton's Third Law means forces always cancel out and nothing can move.", answer: false },
            { id: 4, statement: "If you double the force on an object, you double its acceleration.", answer: true },
            { id: 5, statement: "The Earth pulls you down with gravity, and you pull the Earth up with an equal force.", answer: true },
            { id: 6, statement: "An object at rest will start moving on its own if left long enough.", answer: false },
            { id: 7, statement: "Mass and weight are the same thing.", answer: false },
            { id: 8, statement: "A rocket in space can accelerate even with no air to push against.", answer: true },
            { id: 9, statement: "Friction is always a useless force that only slows things down.", answer: false },
            { id: 10, statement: "If two objects exert equal and opposite forces on each other, they must have the same mass.", answer: false },
        ],
        ...
        questions: [
            ...
            },
            {
                ...
                level: 1,
                type: "crt",
                misconception: "action-reaction-cancels",
                image: null,
            ...
            },
            {
                ...
                level: 1,
                type: "misconception_probe",
                misconception: "constant-speed-requires-force",
                image: null,
            ...
            },
            {
                ...
                level: 3,
                type: "misconception_probe",
                misconception: "force-causes-motion",
                image: null,
            ...
            },
            {
                ...
                misconception: null,
                image: null,
                question: "There are approximately 37 trillion cells in the human body. Block A (4 kg) and Block B (6 kg) hang from either end of a string over a frictionless pulley. What is the acceleration of the system?",
                options: [
                    "$2 \\ \\text{m/s}^2$",
                    "$9.8 \\ \\text{m/s}^2$",
                    "$1.96 \\ \\text{m/s}^2$",
